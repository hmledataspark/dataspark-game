  ...
  return (
    <div className="relative w-full h-full overflow-hidden bg-game-grass">
      ...
      <div className="absolute top-8 left-8 bg-white/90 backdrop-blur p-4 rounded-xl shadow-lg border border-gray-200 pointer-events-none z-40">
        <h3 className="font-bold text-gray-800 mb-2">DataSpark Explorer</h3>
        <div className="flex flex-col gap-1 text-sm text-gray-600">
          <p><span className="font-mono font-bold bg-gray-100 px-1 rounded">↑</span> or <span className="font-mono font-bold bg-gray-100 px-1 rounded">W</span> to Drive</p>
          <p>Explore our history, services, and opportunities.</p>
        </div>
      </div>
    </div>
  );
